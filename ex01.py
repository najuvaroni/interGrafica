...
def clique():
    ...
    if var1 > var2:
        ...
        texto1.configure(text=caixa2.get())
...
texto1 = tk.CTkLabel(janela, text="Insira os números e descubra o maior: ", text_color="black")
...
caixa1= tk.CTkEntry(janela, placeholder_text="Digite o primeiro número:", width=200, height=30)
